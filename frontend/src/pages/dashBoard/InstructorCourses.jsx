...
import { faEdit, faTrash, faPlus, faBookOpen, faClipboardList, faComments, faCheckCircle, faClock } from "@fortawesome/free-solid-svg-icons";
          ...
          <div className="px-4 px-md-5 py-4 border-bottom bg-primary bg-gradient bg-opacity-10">
            <div className="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
              <div>
                ...
                <p className="text-muted mb-0">Manage your uploaded courses and content</p>
              </div>
              <Button
                variant="primary"
                  ...
                  <Card key={course.course_id} className="border border-light rounded-3 shadow-sm hover-shadow transition">
                    <Card.Body className="p-4 d-flex flex-column flex-lg-row align-items-lg-start justify-content-between gap-4">
                      <div className="flex-grow-1">
                        ...
                        <Row className="g-3 mb-2">
                          ...
                          <Col md="auto" className="d-flex align-items-center gap-2">
                            ...
                            <span className="fw-semibold text-dark small"> {course.students || 0} </span>
                          </Col>
                        </Row>
                      </div>
                      ...
                      <div className="d-flex flex-wrap align-items-center gap-2 ms-lg-4">
                        <Link 
                          to={`/discussion/${course.course_id}`} 
                          className="btn btn-primary d-inline-flex align-items-center gap-2 px-3 py-2 rounded-2 fw-medium shadow-sm transition hover-scale"
