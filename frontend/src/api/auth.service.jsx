...
async function resetPasswordWithDetails(email, username, dob, mobileNumber, newPassword) {
  try {
    const response = await fetch(`${API_BASE_URL}/api/auth/reset-password-with-details`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
      body: JSON.stringify({ email, username, dob, mobileNumber, newPassword }),
    });
